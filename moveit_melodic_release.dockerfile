...
RUN apt-get update \
        ...
        golang clang-tidy-9 clang-format-10 \
        ...
        ros-melodic-srdfdom \
        ros-melodic-ifopt \
        ros-melodic-moveit-resources-prbt-moveit-config \
        ros-melodic-moveit-resources-prbt-support \
        ros-melodic-moveit-resources-prbt-pg70-support \
        &&  apt-get clean \
        cd / \
